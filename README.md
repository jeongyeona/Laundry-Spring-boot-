...
💳 결제 및 환불 안내
Laundry365는 Iamport(아임포트)를 통한 카드 결제 시뮬레이션 기능을 제공합니다.

사용자는 결제 완료 후 마이페이지에서 환불 요청을 직접 수행할 수 있습니다.

⏳ 환불 처리는 PG사와 카드사 정책에 따라 다소 시간이 소요될 수 있습니다 (수 분 ~ 최대 1~3일 소요될 수 있음).
